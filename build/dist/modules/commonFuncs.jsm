...
var EnigmailFuncs = {
  ...
  /**
   * Display the dialog to enter Facebook Login Data
   *
   * @win        - |object| holding the parent window for the dialog
   * @resultObj  - |object| with member pass (String) and name (String)
   *
   * no return value
   */

  loginFb: function (win, resultObj) //resultObj
  {
    //resultObj.pass="";
    //resultObj.name="";
    ...
    var valueObj = {};
    //chrome://enigmail/content/FacebookDialog.xul",
    win.openDialog("chrome://enigmail/content/FacebookDialog.xul", //register xul in jar.mn
          "", "dialog,modal,centerscreen", valueObj, resultObj); // How to pass data from window to program?


    //EnigAlert("here");//resultObj.value + " " + resultObj.value);//here
  ...
  /**
   * Display the dialog to export a key to Facebook 
   *
   * @win        - |object| holding the parent window for the dialog
   * @resultObj  - |object| with member pass (String) and name (String)
   *
  ...
  exportFb: function (win, resultObj) //resultObj
  {
    //resultObj.pass="";
    //resultObj.name="";
    ...
    var valueObj = {};
    //chrome://enigmail/content/FacebookDialogExport.xul",
    win.openDialog("chrome://enigmail/content/FacebookDialogExport.xul", //register xul in jar.mn
          "", "dialog,modal,centerscreen", valueObj, resultObj); // How to pass data from window to program?
