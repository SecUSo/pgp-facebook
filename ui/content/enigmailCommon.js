...
function EnigFacebook(){
  EnigmailFuncs.openFacebook();
}
...
// get keys from keyserver ****************************************************************** to commonfuncs.jsm
function EnigDownloadKeys(inputObj, resultObj) {
  return EnigmailFuncs.downloadKeys(window, inputObj, resultObj);
}

function enigmailLoginFb(resultObj) {
  return EnigmailFuncs.loginFb(window, resultObj);
}

function enigmailExportFb(resultObj) {
  return EnigmailFuncs.exportFb(window, resultObj);
}
